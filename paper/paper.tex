...
to the nifti format, without any intermediate step through the DICOM standard formats \cite{Mildenberger2002}. %A command line interface is provided as well to allow for the automatic conversion of a dataset within a pipeline. 
