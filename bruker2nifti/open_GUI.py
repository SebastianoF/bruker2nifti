...
class BrukerToNiftiGUI(tk.Tk, object):
    ...
    def __init__(self, in_pfo_input=None, in_pfo_output=None, in_study_name=None):
        ...
        self.CheckVar_cs = tk.IntVar(value=1)  # correct visu_slope default True
        ...
        self.radio_button_correct_visu_slope = tk.Checkbutton(self, text='correct visu_slope', variable=self.CheckVar_cvs)
        self.radio_button_correct_reco_slope = tk.Checkbutton(self, text='correct reco_slope', variable=self.CheckVar_crs)
        ...
        self.header.grid(row=0, column=1, columnspan=4)
        ...
        self.radio_button_correct_visu_slope.grid(row=4, column=0)
        self.radio_button_correct_reco_slope.grid(row=4, column=1)
        self.radio_button_get_acqp.grid(row=4, column=2)
        self.radio_button_get_method.grid(row=4, column=3)
        self.radio_button_get_reco.grid(row=4, column=4)
    ...
    def convert(self):
        ...
        print('Correct visu slope : {}'.format(self.CheckVar_cvs.get()))
        ...
        bru.correct_visu_slope = self.CheckVar_cvs.get()
        bru.correct_reco_slope = self.CheckVar_crs.get()
